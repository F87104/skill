#!/usr/bin/env python3
"""
Project Prometheus v11.1 [Efficiency Fix Edition]
待機時間といいね効率を改善
"""
...
class PrometheusV11_1:
        ...
        try:
            if file_path.exists():
                with file_path.open('r', encoding='utf-8') as f:
                    ...
                    return {k: v for k, v in data.items() if datetime.fromisoformat(v) > one_day_ago}
    ...
    def run(self):
        log_info("--- Project Prometheus v11.1 [Efficiency Fix Edition] ---")
        ...
        try:
            ...
            for tweet in tweets:
                ...
                try:
                    ...
                    # ========== 修正点 2: POWERFUL_MODEを反映 ==========
                    is_target = powerful_mode or (any(k in text for k in target_keywords) and not any(k in text for k in exclude_keywords))
