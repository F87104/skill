#!/usr/bin/env python3
"""
Project Prometheus v12.10 [Handle Fix Edition]
ユーザー名（@handle）の取得方法を修正し、表示名とユーザー名を正確に区別する
"""
...
class PrometheusV12_10:
    ...
    def run(self):
        log_info("--- Project Prometheus v12.10 [Handle Fix Edition] ---")
