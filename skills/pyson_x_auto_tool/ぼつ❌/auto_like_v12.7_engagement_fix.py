#!/usr/bin/env python3
"""
Project Prometheus v12.7 [Engagement Fix Edition]
「ポストのエンゲージメントを表示」から「いいね」一覧を開く、新方式に対応
"""
...
class PrometheusV12_7:
    ...
    def run(self):
        log_info("--- Project Prometheus v12.7 [Engagement Fix Edition] ---")
