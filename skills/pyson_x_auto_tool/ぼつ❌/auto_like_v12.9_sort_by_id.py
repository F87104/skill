#!/usr/bin/env python3
"""
Project Prometheus v12.9 [Sort by ID Edition]
ツイートIDを数値としてソートし、新しい順にいいね返しを実行する
"""
...
class PrometheusV12_9:
    ...
    def run(self):
        log_info("--- Project Prometheus v12.9 [Sort by ID Edition] ---")
    ...
    def run_full_likeback_cycle(self, page):
        ...
        try:
            ...
            for _ in range(self.config.getint('Likeback', 'MAX_TWEET_SCROLLS', 5)):
                ...
                tweet_urls_on_page.sort(key=get_status_id, reverse=True)
                log_info(f"収集したツイートを新しい順にソートしました。")
