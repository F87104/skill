#!/usr/bin/env python3
"""
Project Prometheus v12.11 [Time Sort Fix Edition]
ツイートのタイムスタンプを直接取得・ソートし、固定ツイートを確実に除外する
"""
...
class PrometheusV12_11:
    ...
    def run(self):
        log_info("--- Project Prometheus v12.11 [Time Sort Fix Edition] ---")
    ...
    def run_full_likeback_cycle(self, page):
        ...
        try:
            ...
            for _ in range(self.config.getint('Likeback', 'MAX_TWEET_SCROLLS', 5)):
                ...
                for _, tweet_url in tweets_with_time:
