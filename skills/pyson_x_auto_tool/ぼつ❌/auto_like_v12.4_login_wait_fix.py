#!/usr/bin/env python3
"""
Project Prometheus v12.4 [Login Wait Fix Edition]
ログイン待機処理を改善し、確実にログイン完了を待ってから処理を開始するようにする
"""
...
class PrometheusV12_4:
    ...
    def run(self):
        log_info("--- Project Prometheus v12.4 [Login Wait Fix Edition] ---")
    ...
    def check_and_perform_login(self, page):
        try:
            ...
            if login_button.count() > 0:
                ...
                # --- 修正点: ログイン完了まで最大5分待機 --- #
                log_info("ログイン完了を待っています...")
                try:
                    page.wait_for_url("https://x.com/home", timeout=300000) # 5分
